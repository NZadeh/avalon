...
assignRolesToPlayersInPlace = function(players) {
    ...
    shuffledRoles.forEach(function(role, index) {
        ...
        players[index][kRoleField][kRoleNameField] = role.name();
    ...
    players.forEach(function(player, index) {
        ...
        console.assert(playerRole.name() == player[kRoleField][kRoleNameField],
...
Meteor.methods({
    ...
    'startGame': function(roomId) {
        ...
        if (gameRoom.userId === Meteor.userId()) {
            ...
            //if (players.length < kMinPlayers) return { notEnoughPlayers: true };  TODO(neemazad): reenable after testing
            if (players.length > kMaxPlayers) return { tooManyPlayers: true };
