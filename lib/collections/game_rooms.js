...
// TODO(neemazad): Figure out why this is necessary.
// Called on the Router onStop method, which seems to trigger
// whenever we're about to go to a new route (e.g. click the Avalon
// link from a game lobby to go to "home")
export const leaveRoom = new ValidatedMethod({
  name: 'avalon.leaveRoom',
